...
const TTL = 300000;
const _DEFAULTS = { device: 'default', prefix: '.', mode: 'public', gcpresence: false, antitag: false, antidelete: true, antilink: 'off', chatbotpm: false, packname: 'Codex-MD', author: 'Codex', multiprefix: false, stealth: false, startmessage: true, autoview: false, autoai: false, codexagent: false, autoreact: false, autotyping: false, autostatus: false, warn_limit: 3, autobio: false, presence: 'off', autoread: false, autolike: false, anticall: false };
