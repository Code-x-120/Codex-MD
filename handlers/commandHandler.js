...
const EXTRA_ALIASES = {
  ...
  setmenupic: ['menupic', 'bpic', 'setbotpic'],
  setbotname: ['botname', 'namebot', 'setname'],
  setpp:      ['setbotpp', 'setdp', 'setprofilepic'],
  setabout:   ['setstatus', 'setbio', 'updatestatus'],
  autoreact:  ['autoreaction', 'autoreactmsg'],
  autotyping: ['autotype', 'typing'],
  jid:        ['getjid', 'myjid', 'whatsmyid'],
  nice:       ['69', 'nicemoment'],
  whitelist:  ['wl', 'trusted'],
  compliment: ['praise', 'complimentme', 'wholesome'],
  ship:       ['shipit', 'match', 'love'],
  meme:       ['memes', 'memeimg'],
  ttprofile:  ['tiktokprofile', 'tiktokuser', 'ttuser'],
};
